...
static int window, value = 0, menu_id;
float x[20], buby[20] = { -.95 }, bubx = -3.14, r[20], offset[20], pos[20], z[20], yy[20], speed[20], sizee[20], grass[100], ff = -.6, tv[20] = { 0 };
int dx[20] = { 1 }, bx = 1, zx[20], ee[20], fx = 1,quantity=5;
int colors[20][3] = { {255, 165, 0},
    {242, 38, 19},
    {44, 62, 80},
    {219, 10, 91},
    {236,236,236},
...
int main(int argc, char** argv)
{
    ...
    window=glutCreateWindow("An Aquarium");          // Create window with the given title
    createmenu();
...
void createmenu(void) {
    ...
    glutAddMenuEntry("ADD A FISH", 1);
    glutAddMenuEntry("REMOVE A FISH", 2);
    glutAddMenuEntry("EMPTY THE AQUARIUM", 3);
